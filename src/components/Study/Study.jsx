...
const kjvnControls=useAnimation()
  ...
  return (
    ...
    <motion.div transition={{delay:0.6,duration:0.9}} variants={{hidden:{opacity:0 },visible:{ opacity:1}}} initial="hidden"  animate={kjControls} >
  ...
  <Flex direction={'column'} alignItems={'center'} gap={3} rounded={'4rem'} overflow={'hidden'} p={10} bgGradient={'linear(to-bl,rgb(15,23,42),rgb(28,25,23))'}>
    ...
    <motion.div transition={{delay:0.3}} variants={{hidden:{opacity:0 },visible:{ opacity:1}}} initial="hidden"  animate={kjvnControls} >
