...
import gen1 from '../../assets/genesis.jpg'
...
function Genesis() {
    const images=[gen1,gen2,gen3,gen4,gen5]
  return (
    <Flex px={4}   direction={'column'} mt={8}>
        <Text cursor={'context-menu'} color={'#60a5fa'}>DBMS Project</Text>
        <Text cursor={'context-menu'} color={'white'} fontSize={'4xl'}>Genesis</Text>
        <Flex w={24} bgColor={' rgb(30 41 59)'} _hover={{bgColor:'rgb(7 89 133)',}} h={12} px={3} py={2} alignItems={'center'} mt={4} rounded={10}>
        <Link _hover={{textDecoration:'none'}} href='https://github.com/lovebin123/Genesis' isExternal>
        ...
        <Text letterSpacing={' 0.050em'} color={'white'}>"In India, parenthood journeys are often marked by challenges in germ cell donation and adoption. Outdated methods cause frustration and heartbreak. <br></br><br></br>We believe everyone deserves a family. Our software solution tackles these barriers head-on. Designed for India, our platform offers a clear pathway to conception and adoption. <br></br><br></br>We're not just streamlining processes, but offering hope. We aim to bring joy to many families and leave a lasting impact on reproductive medicine. Our solution revolutionizes germ cell donation and adoption in India.
</Text>
