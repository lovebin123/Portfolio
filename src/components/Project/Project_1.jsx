    ...
    <Flex direction={'column'} px={20} mb={5} w={'full'} h={'full'}>
      ...
      <Flex className='containers' flexWrap={'wrap'}  mt={6}>
        {projects.map((project, index) => (
          ...
          <motion.div style={{display:'flex',justifyContent:'center'}} variants={{"hidden":{translateY:100, opacity:0},"visible":{translateY:0, opacity:1}}} transition={{delay:0.4,duration:0.8,type:'tween'}} initial="hidden" animate={projectControls} >
            <ProjectCard
