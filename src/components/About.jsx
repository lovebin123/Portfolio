import { Avatar, Flex,Image,Link,Text,keyframes } from '@chakra-ui/react'
...
function About() {
  ...
  return (
   ...
   <Image objectFit={'cover'} src={me} w={20} height={20} rounded={'1rem'}/>
        ...
        <Flex justifyContent={'space-between'} wrap={'wrap'} px={20}>
        <Flex w={'30rem'} h={100}>
      ...
      <Image overflowY={'hidden'} className='gameboy'  w={'50rem'} src={gameboy} position={'relative'} left={60} ></Image>
      </Flex>
        </Flex>
    </Flex>
  )
