...
function About() {
  return (
    ...
    <Flex justifyContent={'space-between'} pr={20} pl={20} position={'sticky'}  >
        <Flex   alignItems={'center'} gap={6}>
          <Avatar src={me} boxSize={20}/>
          <Text display={'inline-block'} whiteSpace={'nowrap'} color={'white'}>LOVEBIN JOSEPH ROBIN</Text>
        </Flex>
        ...
        <Link href='lovebinjosephrobin.mec@gmail.com' isExternal>
